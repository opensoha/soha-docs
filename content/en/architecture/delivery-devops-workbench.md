...
| 流程审批节点 | 发布、平台 | 在发布流程模板中管理测试升级、预发、生产发布等门禁 |
...
| `workflow_approvals` | 流程审批记录 | 发布流程 `manual_approval` 节点的审批决策和关联元数据 |
...
- `internal/repository/delivery`
  - Bundle、execution task、artifact。
